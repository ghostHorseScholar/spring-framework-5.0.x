...
public abstract class BeanUtils {
	 ...
	 *
	 * 使用给定构造函数实例化类的方便方法。
	 * <p>注意，如果给定一个不可访问(即非公共)的构造函数，该方法将尝试将构造函数设置为可访问的，并且支持带有可选参数和默认值的Kotlin类。
	 */
	public static <T> T instantiateClass(Constructor<T> ctor, Object... args) throws BeanInstantiationException {
		...
		try {
			...
			// 通过反射机制获取实例对象
			Boolean isKotlinType = KotlinDetector.isKotlinType(ctor.getDeclaringClass());
			return (isKotlinType ?
