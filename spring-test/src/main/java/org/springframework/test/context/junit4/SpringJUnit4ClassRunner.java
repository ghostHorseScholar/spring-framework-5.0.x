...
/** JUnit包中提供了一个自定义容器加载类(SpringJUnit4ClassRunner),
 * BlockJUnit4ClassRunner在famework中提供了一个TestContextManager(测试容器管理)
 ...
 * @since 2.5
 * @see SpringRunner  // spring运行
 * @see TestContextManager   // 测试容器管理
 * @see AbstractJUnit4SpringContextTests // 测试上下文摘要
 * @see AbstractTransactionalJUnit4SpringContextTests // 测试上下文事务摘要
 * @see org.springframework.test.context.junit4.rules.SpringClassRule // spring类规则
 * @see org.springframework.test.context.junit4.rules.SpringMethodRule // spring方法规则
 */
